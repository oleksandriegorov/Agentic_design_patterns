...
summarize_chain: Runnable = (
    ...
    | StrOutputParser()  # type: ignore[operator]
)
...
full_parallel_chain = map_chain | synthesis_prompt | llm | StrOutputParser()  # type: ignore[operator]
...
if __name__ == "__main__":
    test_topic = "Vikings and their art of warfare."
